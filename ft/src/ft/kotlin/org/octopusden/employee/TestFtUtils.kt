...
private const val TECHNICAL_USER_BEARER = "TECHNICAL_USER_BEARER"
    ...
    companion object {
        ...
        fun getSecuredClient(): EmployeeServiceClient =
            ClassicEmployeeServiceClient(object : EmployeeServiceClientParametersProvider {
                override fun getBearerToken(): String = System.getenv(TECHNICAL_USER_BEARER)
                    ?: throw IllegalArgumentException("TECHNICAL_USER_BEARER(environment variable) must be not null")
