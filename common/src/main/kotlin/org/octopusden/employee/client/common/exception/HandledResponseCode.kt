...
enum class HandledResponseCode(
    val responseCode: Int,
    val exceptionFunction: (ErrorResponse) -> Nothing,
) {
    ...
    companion object {
        fun mappedException(responseCode: Int): HandledResponseCode? = values().find { it.responseCode == responseCode }
    }
}
